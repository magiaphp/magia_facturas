...
<?php _t("Editar"); ?></h2> 
 ...
 <?php 
                        $campos = array(array(
"type" => "text",
"name" => "presupuesto_id_factura",
"value" => "$presupuesto_id_factura",                                                                        
    
"for" => "presupuesto_id_factura",
"label" => "id_factura",
"class" => "form-control",
"id" => "presupuesto_id_factura",
"placeholder" => "id_factura",
                    ),array(
"type" => "text",
"name" => "presupuesto_cantidad",
"value" => "$presupuesto_cantidad",                                                                        
    
"for" => "presupuesto_cantidad",
"label" => "cantidad",
"class" => "form-control",
...
"value" => "$presupuesto_descripcion",                                                                        
    
"for" => "presupuesto_descripcion",
"label" => "descripcion",
"class" => "form-control",
...
"type" => "text",
"name" => "presupuesto_valor",
"value" => "$presupuesto_valor",                                                                        
    
"for" => "presupuesto_valor",
"label" => "valor",
"class" => "form-control",
...
"type" => "text",
"name" => "presupuesto_porcentaje_iva",
"value" => "$presupuesto_porcentaje_iva",                                                                        
    
"for" => "presupuesto_porcentaje_iva",
"label" => "porcentaje_iva",
"class" => "form-control",
"id" => "presupuesto_porcentaje_iva",
